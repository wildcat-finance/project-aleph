...
`eval/golden-v1.yaml` contains 135 questions clustered from support traffic plus
...
can evaluate the answer path. `eval/product_eval.py` runs the complete 135-case
